...
tags: [robotics, control, embedded systems, hobby]
categories: [robotics, control, embedded systems, hobby]
draft: false
---
...
{{< load-photoswipe >}}
{{< gallery dir="/img/rc-planes/FirstRC" />}}

## Plane with a dihedral wing
...
{{< gallery dir="/img/rc-planes/Dihedral" />}}

## The delta wing

I now wanted to build a delta plane. With just two servo motors, a fusion of aileron, elevator and rudders could be achieved. I used the design template provided by [FliteTest](https://www.flitetest.com/articles/DeltaScratchBuild). While building this plane was easy, flying it was challenging due to the controls being new to me. It was a fun experience.

{{< gallery dir="/img/rc-planes/DeltaWing" />}}
...
{{< gallery dir="/img/rc-planes/Nitro" />}}
